<template>
  <div>
    ...
    <div class="page vcfusion">
      <div class="container">
        <div class="flex justify-space-between align-center">
          <div>
            <h1 class="mt-5">VC Fusion</h1>
            <h3 class="mb-0">Up to 96 Hours of Thermal Protection</h3>
          </div>

          <router-link :to="{ name: 'getstarted'}" tag="button" class="btn product__buttons--item--btn hiddenSmAndDown">Contact Sales<span class="hiddenMdAndDown"> &#8594</span></router-link>
        </div>
        <hr>
        ...
        <!-- <div class="vcfusion__grid mt-5">
          <div class="grid__container">
            <div class="item grid__container--item">
              <img src="https://firebasestorage.googleapis.com/v0/b/vericool-53dd0.appspot.com/o/Products%2FVCFusion%2FVC-fusion.png?alt=media&token=7ac6ebc0-a75c-4c05-a4e8-a9f10f2c71bb" alt="">
            </div>
            <div class="item grid__container--item">
              <img src="https://firebasestorage.googleapis.com/v0/b/vericool-53dd0.appspot.com/o/Products%2FVCFusion%2Fcell-signaling-inside.png?alt=media&token=6140a488-321a-4cc7-ac4e-299707fb5cd5" alt="">
            </div>
          </div>
        </div> -->
        <hr>
        <div class="vcfusion__iconrow">
          <div>
          ...
          <div class="vcfusion__iconrow--item">
            <img class="p" src="https://firebasestorage.googleapis.com/v0/b/vericool-53dd0.appspot.com/o/Products%2Fpatents%2FpAsset%2010.svg?alt=media&token=8a6899e8-d570-4be4-a325-8a328619ad6f">
          </div>
        </div>  
        <hr>
        <div>
        ...
        <div>
          <h2>Innovative Cold Chain Packaging</h2>
          <ul>
...
export default {
  ...
  data () {
    return {
      ...
      slides: [
        'https://firebasestorage.googleapis.com/v0/b/vericool-53dd0.appspot.com/o/Products%2FVCFusion%2FVC-fusion.png?alt=media&token=7ac6ebc0-a75c-4c05-a4e8-a9f10f2c71bb',
        'https://firebasestorage.googleapis.com/v0/b/vericool-53dd0.appspot.com/o/Products%2FVCFusion%2Fcell-signaling-inside.png?alt=media&token=6140a488-321a-4cc7-ac4e-299707fb5cd5'
      ],
      crumbs: [
        {
          title: "All Products",
