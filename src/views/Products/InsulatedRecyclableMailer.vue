<template>
  <div>
    ...
    <div class="page recyclablemailer">
      <!--<div class="recyclablemailer__hero">
      </div>-->
      <div class="container">
        <div class="flex justify-space-between align-center">
          <div>
            <h1 class="mt-5">Insulated Recyclable Mailer</h1>
            <h3 class="mb-0">Recyclable Shipping Envelope</h3>
          </div>
        ...
        <hr>
        <div class="recyclablemailer__grid mt-5">
          <div class="grid__container">
            <div class="item grid__container--item">
              <img src="https://firebasestorage.googleapis.com/v0/b/vericool-53dd0.appspot.com/o/Products%2FMailers%2FmailerAsset%2014%404x.png?alt=media&token=509abbc4-0f20-4c59-8d5b-9f4fe4154439" alt="" style="max-height: 300px;">
            </div>
          </div>
        </div>
        <hr>
        <div class="recyclablemailer__iconrow">
        	<div>
        	...
        	<div class="recyclablemailer__iconrow--item">
        		<img class="p" src="https://firebasestorage.googleapis.com/v0/b/vericool-53dd0.appspot.com/o/Products%2Fpatents%2FiconsAsset%209.svg?alt=media&token=d081378a-7f89-4d83-9cfb-92ecaf0731f9">
        	</div>
        </div>	
        <hr>
        <div>
  ...
  data () {
    return {
      crumbs: [
        ...
        {
          title: "Insulated Recyclable Mailer",
          to: false
        }
      ]
    }
