 ...
 -->
    ...
    <!--<div class="homepage__slider">-->
      ...
      <div class="content-wrapper">
        <div class="homepage__mission">
          <h2>Let our mission <span class="underline--magical">be your mission.</span></h2>
        </div>
      </div>
      <div class="background pt-5 pb-5" data-aos="fade" data-aos-once="true">
      <div class="content-wrapper" style="background-color: transparent;">
        <h2 class="mt-5 mb-5 pb-3">We Manufacture Environmentally-Friendly Packaging</h2>
        <What />
      ...
      <div class="background pt-5 pb-5" data-aos="fade" data-aos-once="true">
        <div class="content-wrapper" style="background-color: transparent;">
          <h2 class="mb-5">Latest Updates:</h2>
            ...
            <div v-for="item in articles.slice(0, 2)" v-if="articles && articles.length >= 1">
              <router-link :to="`/news/` + item.id">
                <div class="homepage__news--item" >
                  ...
                  <h4 class="dark-text mb-0">{{item.title}}  &#8594</h4>
                </div>
              </router-link>
            </div>
          </div>
