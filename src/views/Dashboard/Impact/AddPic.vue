        ...
        blob => {
          ...
          picRef.put(blob).then((snap) => {
            picRef.getDownloadURL().then(function(downloadURL) {
              ...
              fb.impactPicsCollection.add({
                picUrl: downloadURL,
              })
              .then(
                doc => {
                  fb.impactPicsCollection.doc(doc.id).update({
                    id: doc.id,
